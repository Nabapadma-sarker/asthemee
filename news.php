  ...
  <div class="main_news_article">
   <div class="container">
     <div class="row">
       ...
       <div class="col-md-3">
	    <?php wp_nav_menu( array( 'container' => '' ,'link_before' => '<i></i>','items_wrap'=>'<ul class="category-list"> %3$s </ul>','theme_location'  => 'news_sidebar')); ?>
	   </div>
	   <div class="col-md-9">
        ...
        <?php $subcategory_products = new WP_Query( array( 'post_type' => 'news', 'newstype' => $wsc->slug, 'posts_per_page'=>-1) );
