...
<body>
 <div class="home">
  <header>
   ...
   <div class="container">
	 ...
	 <div class="row">
	     ...
	     <div id="myCarousel2" class="carousel slide">
                <div class="carousel-inner">
                    ...
                    <div class="item <?php if($i==0){echo "active";}?>">
					 <div class="row mobile_home hide_one_div1" style="background: url('<?php  echo $src[0]; ?>');">
	  ...
	  <div id="myCarousel3" class="carousel slide hide_one_div">
                <div class="carousel-inner">
				        <?php
					 $args = array( 'post_type' => 'banners', 'order'   => 'ASC', 'posts_per_page'=>3 );
					$loop = new WP_Query( $args );
					...
					while ( $loop->have_posts() ) : $loop->the_post();
					 ?>
				     <div class="item <?php if($i==0){echo "active";}?>">
					  <div class="row hide_one_div">
						<div class="col-sm-8 home_slider_content">
						 <?php the_content(); ?>
						</div>
						<div class="col-sm-4 home_slider_button">
  ...
  <div class="header_bottom">
    <div class="container">
     <div class="row">	   
	   <div class="col-sm-6 login-form-container"> 
